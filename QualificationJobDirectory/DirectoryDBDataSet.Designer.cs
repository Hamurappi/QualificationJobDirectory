...
namespace QualificationJobDirectory {
    ...
    public partial class DirectoryDBDataSet : global::System.Data.DataSet {
        ...
        public partial class WorkersDataTable : global::System.Data.TypedTableBase<WorkersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public WorkersRow AddWorkersRow(string FullName, string Position, string Phone, byte[] Photo) {
        ...
        public partial class WorkersRow : global::System.Data.DataRow {
            ...
            public byte[] Photo {
                get {
                    try {
                        return ((byte[])(this[this.tableWorkers.PhotoColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace QualificationJobDirectory.DirectoryDBDataSetTableAdapters {
    ...
    public partial class WorkersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Workers] WHERE (([Id] = @Original_Id) AND ([FullName] = @Original_FullName) AND ((@IsNull_Position = 1 AND [Position] IS NULL) OR ([Position] = @Original_Position)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Workers] ([FullName], [Position], [Phone], [Photo]) VALUES (@F" +
                "ullName, @Position, @Phone, @Photo);\r\nSELECT Id, FullName, Position, Phone, Phot" +
                "o FROM Workers WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Workers] SET [FullName] = @FullName, [Position] = @Position, [Phone] = @Phone, [Photo] = @Photo WHERE (([Id] = @Original_Id) AND ([FullName] = @Original_FullName) AND ((@IsNull_Position = 1 AND [Position] IS NULL) OR ([Position] = @Original_Position)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)));
SELECT Id, FullName, Position, Phone, Photo FROM Workers WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::QualificationJobDirectory.Properties.Settings.Default.DirectoryDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FullName, Position, Phone, Photo FROM dbo.Workers";
        ...
        public virtual int Fill(DirectoryDBDataSet.WorkersDataTable dataTable) {
        ...
        public virtual DirectoryDBDataSet.WorkersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DirectoryDBDataSet.WorkersDataTable dataTable = new DirectoryDBDataSet.WorkersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DirectoryDBDataSet.WorkersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_FullName, string Original_Position, string Original_Phone) {
        ...
        public virtual int Insert(string FullName, string Position, string Phone, byte[] Photo) {
            if ((FullName == null)) {
        ...
        public virtual int Update(string FullName, string Position, string Phone, byte[] Photo, int Original_Id, string Original_FullName, string Original_Position, string Original_Phone, int Id) {
            if ((FullName == null)) {
                throw new global::System.ArgumentNullException("FullName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FullName, string Position, string Phone, byte[] Photo, int Original_Id, string Original_FullName, string Original_Position, string Original_Phone) {
            return this.Update(FullName, Position, Phone, Photo, Original_Id, Original_FullName, Original_Position, Original_Phone, Original_Id);
        }
    }
